...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class MaybankFileGenController : Controller
    {
        ...
        public ViewResult _TaxCP39Prev(int? WilayahIDList, int? LadangIDList, int? MonthList, int? YearList, string print)
        {
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
            int? getuserid = getidentity.ID(User.Identity.Name);
            string host, catalog, user, pass = "";
        ...
        public JsonResult TaxCP39DetailPrev(int? Region, int? Estate, int Month, int Year)
        {
            string msg = "";
            string statusmsg = "";
            int? NegaraID, SyarikatID, WilayahID, LadangID = 0;
        ...
        [HttpPost]
        public ActionResult DownloadCP39TextFilePrev(int Month, int Year, int? Region, int? Estate)
        {
            string msg = "";
            string statusmsg = "";
            string link = "";
