...
namespace MVC_SYSTEM.Controllers
{
    public class IDApplicationController : Controller
    {
        ...
        public ActionResult Index(string ApplyCode)
        {
            ...
            //Add by fitri 3 - 02 - 2021
            List<SelectListItem> kdldg = new List<SelectListItem>();
            kdldg = new SelectList(dbC.tbl_Ladang.Where(x => x.fld_Deleted == false).OrderBy(o => o.fld_LdgCode).Select(s => new SelectListItem { Value = s.fld_LdgCode, Text = s.fld_LdgName }), "Value", "Text").ToList();
            kdldg.Insert(0, (new SelectListItem { Text = "All", Value = "0" }));
            ViewBag.kdldg = kdldg;
            return View();
        }
        ...
        public JsonResult GetBatchNo(string kodladang, string kdprmhnan)
        {
            ...
            var getbatchno = dbC.tblOptionConfigsWebs.Where(x => x.fldOptConfFlag1 == "useridbatchno" && x.fldDeleted == false && x.fld_NegaraID == GetNSWLDetail.fld_NegaraID && x.fld_SyarikatID == GetNSWLDetail.fld_SyarikatID).FirstOrDefault();

            genbatchno = kdprmhnan + kodladang + "userid" + getbatchno.fldOptConfValue;
            convertint = int.Parse(getbatchno.fldOptConfValue) + 1;

            getbatchno.fldOptConfValue = convertint.ToString();
        ...
        public JsonResult SearchBatch(int batchno, string kodladang, string kdprmhnan)
        {
            ...
            {
                statussbmt = "Application not submitted";
            }
            ...
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"15%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Identification Card No.</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"20%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Designation</th>";
            ...
            if (getNotiStatus != null)
            {
                msg = "Data found and cannot be edited.";
                statusmsg = "success";
                status = true;
            }
            else
        ...
        public ActionResult Edit(int fldID, string fldUserFullName, string fldNoKP, string PositionList, string fldUserShortName, string fldUserEmail, int BatchID)
        {
            ...
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"5%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Bil</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"20%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Name</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"15%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Identidication Card No.</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"20%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Designation</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"15%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">User ID</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"15%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Status</th>";
            tablelisting += "<th bgcolor=\"#073e5f\" width=\"10%\" style=\"color:white; text-align:center; vertical-align:middle;border:1px solid black;\" border=\"1\">Action</th>";
