    ...
    public class ResourceController : Controller
    {
        ...
        public ActionResult Edit(tblTKADetail tblTKADetail, string GenderList, string KerakyatanList, string BusinesList, string RelationshipList, string DependantAdd)
        {
            try
            {
                ...
                return Json(new { success = true, msg = "Data successfully edited.", status = "success", linktbllist = Url.Action("UpdateListData", "Resource", null, "http"), batchid = tblTKADetail.fldTKABatchID });
            }
            catch (Exception ex)
            {
