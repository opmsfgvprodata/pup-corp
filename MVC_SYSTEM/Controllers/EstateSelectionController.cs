    ...
    public class EstateSelectionController : Controller
    {
        ...
        public ActionResult EstateSelection()
        {
            ...
            if (WilayahID == 0 && LadangID == 0)
            {
                ...
                LadangIDList = new SelectList(db2.tbl_Ladang.Where(x => x.fld_WlyhID == wilayahid && x.fld_Deleted == false).OrderBy(o => o.fld_LdgName).Select(s => new SelectListItem { Value = s.fld_ID.ToString(), Text = s.fld_LdgCode + " - " + s.fld_LdgName }), "Value", "Text").ToList();
            }
        ...
        public ActionResult EstateSelection(int WilayahIDList, int LadangIDList)
        {
            ...
            if (getestateselection != null)
            {
                ...
                getestateselection.fld_HQUrl = Url.Action("", "", null, Request.Url.Scheme);   
            ...
            else
            {
                ...
                tbl_EstateSelection.fld_HQUrl = Url.Action("", "", null, Request.Url.Scheme);
