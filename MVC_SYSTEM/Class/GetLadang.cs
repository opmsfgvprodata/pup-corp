...
namespace MVC_SYSTEM.Class
{
    public class GetLadang
    {
        ...
        //add by wani 9.2.2021
        public bool GetAvailableDivision(int? WilayahID, int? LadangID)
        {
            bool result = false;

            var getldivision = dbCorp.tbl_Division.Where(x => x.fld_WilayahID == WilayahID && x.fld_LadangID == LadangID && x.fld_Deleted == false).Count(); //fitri edit
